...
python -m nmt.nmt \
    --src=en --tgt=vi \
    --ckpt=/pretrained_model/envi_model_2/translate.ckpt \
    --hparams_path=nmt/standard_hparams/iwslt15.json \
    --out_dir=/tmp/envi \
    --vocab_prefix=/pretrained_model/envi_model_2/vocab \
    --inference_input_file=/pretrained_model/envi_model_2/tst2013.en \
    --inference_output_file=/tmp/envi/output_infer \
    --inference_ref_file=/pretrained_model/envi_model_2/tst2013.vi

python -m nmt.nmt --src=en --tgt=vi --ckpt=pretrained_model/envi_model_2/translate.ckpt --hparams_path=nmt/standard_hparams/iwslt15.json --out_dir=/tmp/envi --vocab_prefix=pretrained_model/envi_model_2/vocab --inference_input_file=pretrained_model/envi_model_2/tst2013.en --inference_output_file=tmp/envi/output_infer  --inference_ref_file=pretrained_model/envi_model_2/tst2013.vi

python -m nmt.nmt --src=en --tgt=vi --ckpt=pretrained_model/envi_model_2/translate.ckpt --hparams_path=nmt/standard_hparams/iwslt15.json --out_dir=/tmp/envi --vocab_prefix=pretrained_model/envi_model_2/vocab --inference_input_file=pretrained_model/envi_model_2/test.en --inference_output_file=tmp/envi/output_infer

python nmt.py --src=en --tgt=vi --ckpt=pretrained_model/translate.ckpt --hparams_path=standard_hparams/iwslt15.json --out_dir=output_inference/result --vocab_prefix=pretrained_model/vocab --inference_input_file=pretrained_model/test.en --inference_output_file=/output_inference/result
...
--out_dir=/tmp/envi
--vocab_prefix=pretrained_model/envi_model_2/vocab
--inference_input_file=pretrained_model/envi_model_2/test.en
--inference_output_file=tmp/envi/output_infer
